...
lr_start_transaction("5-upload_img_sock");
	...
	lrs_create_socket("socket0", "TCP", "LocalHost=0", "RemoteHost=172.16.56.112:28390", LrsLastArg);
...
lr_start_transaction("9-download_first_img_sock");
	...
	lrs_create_socket("socket1", "TCP", "LocalHost=0", "RemoteHost=172.16.56.112:28390", LrsLastArg);
